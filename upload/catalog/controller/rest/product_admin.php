...
class ControllerRestProductAdmin extends RestAdminController
{
    ...
    private function getProductInfo($product)
    {
        ...
        foreach ($product_specials as $product_special) {
            $specials[] = array(
                ...
                'price_excluding_tax' => $product_special['price'],
        ...
        foreach ($product_discounts as $product_discount) {
            $discounts[] = array(
                ...
                'price_excluding_tax' => $product_discount['price'],
                ...
                if (!empty($option['product_option_value'])) {
                    foreach ($option['product_option_value'] as $option_value) {
                        ...
                        $option_value_data[] = array(
                            ...
                            'price_excluding_tax' => (float)$option_value['price'],
                            'price_excluding_tax_formated' => $this->currency->format($option_value['price'], $this->config->get('config_currency')),
    ...
    private function getProductBaseInfo($product)
    {
        ...
        $item = array(
            ...
            'price_excluding_tax_formated' => $this->currency->format($product['price'], $this->config->get('config_currency')),
            'price' => $this->tax->calculate($product['price'], $product['tax_class_id'], $this->config->get('config_tax')),
            'price_formated' => $this->currency->format($this->tax->calculate($product['price'], $product['tax_class_id'], $this->config->get('config_tax')), $this->config->get('config_currency')),
            'special' => $special,
