    ...
    private function getOrderDetailsToOrder($order_info)
    {
        ...
        if (!empty($order_info)) {
            ...
            foreach ($products as $product) {
                ...
                if (empty($origProduct) || !is_array($origProduct)) {
                    return [];
                }
                ...
                $orderData['products'][] = array(
                    ...
                    'name' => $product['name'],
                    'model' => $product['model'],
                    'ean' => (!empty($origProduct['ean']) ? $origProduct['ean'] : ""),
                    'jan' => (!empty($origProduct['jan']) ? $origProduct['jan'] : ""),
                    'isbn' => (!empty($origProduct['isbn']) ? $origProduct['isbn'] : ""),
                    'mpn' => (!empty($origProduct['mpn']) ? $origProduct['mpn'] : ""),
